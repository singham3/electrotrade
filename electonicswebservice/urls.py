...
urlpatterns = [
    ...
    path('api/v1/user/login/otp/send/', login_with_otp_send),
    path('api/v1/user/login/otp/verify/', login_with_otp_verify),
    path('api/v1/user/logout/', user_logout_view),
    path('api/v1/user/mobile/verify/', verify_mobile_view),
    path('api/v1/user/email/otp/send/', verify_email_otp_send_view),
    path('api/v1/user/email/otp/verify/', verify_email_otp_verify_view),
